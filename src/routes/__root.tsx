...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Interactive biology lab reports — microscope observation, respiration, dissection, and specimen study." },
      { property: "og:title", content: "Biology Lab Reports" },
      { property: "og:description", content: "Interactive biology lab reports — microscope, respiration, dissection, specimens." },
